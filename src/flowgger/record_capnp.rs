  ...
  impl <'a,> Builder<'a,>
   {
    ...
    #[inline]
    pub fn set_extra(&mut self, value : struct_list::Reader<'a,::record_capnp::pair::Owned<>>) -> Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(8), value)
    }
    #[inline]
    pub fn init_extra(self, size : u32) -> struct_list::Builder<'a,::record_capnp::pair::Owned<>> {
